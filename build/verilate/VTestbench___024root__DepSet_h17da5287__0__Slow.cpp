...
#endif
            VL_FATAL_MT("/mnt/d/sysI/sys1-sp25/src/lab3-2/../../repo/sys-project/lab3-2/sim/testbench.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VTestbench___024root___ctor_var_reset(VTestbench___024root* vlSelf) {
    ...
    vlSelf->Testbench__DOT__cnt_24__DOT__high_reset = VL_RAND_RESET_I(1);
