...
VL_ATTR_COLD void VTestbench___024root__trace_init_sub__TOP__0(VTestbench___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+10,0,"low_bits_carry",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+11,0,"low_bits",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+12,0,"high_bits",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBit(c+17,0,"high_rst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void VTestbench___024root__trace_full_0_sub_0(VTestbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,(vlSelfRef.Testbench__DOT__co));
    ...
    bufp->fullBit(oldp+10,((9U == (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits))));
    bufp->fullCData(oldp+11,(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits),4);
    bufp->fullCData(oldp+12,(vlSelfRef.Testbench__DOT__cnt_24__DOT__high_bits),4);
    bufp->fullBit(oldp+13,((9U == (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__high_bits))));
    bufp->fullIData(oldp+14,(vlSelfRef.Testbench__DOT__co),32);
    bufp->fullIData(oldp+15,((((IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__high_bits) 
                               << 4U) | (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits))),32);
    bufp->fullBit(oldp+16,(vlSelfRef.Testbench__DOT__clk));
    bufp->fullBit(oldp+17,(vlSelfRef.Testbench__DOT__cnt_24__DOT____Vcellinp__HIGH_CNT__high_rst));
}
