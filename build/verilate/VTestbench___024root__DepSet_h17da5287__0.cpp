...
VL_INLINE_OPT void VTestbench___024root___act_sequent__TOP__0(VTestbench___024root* vlSelf) {
    ...
    vlSelfRef.Testbench__DOT__cnt_24__DOT____Vcellinp__HIGH_CNT__high_rst 
        = ((IData)(vlSelfRef.Testbench__DOT__high_rst) 
           | (IData)(vlSelfRef.Testbench__DOT__co));
}
...
VL_INLINE_OPT void VTestbench___024root___nba_sequent__TOP__0(VTestbench___024root* vlSelf) {
    ...
    if (vlSelfRef.Testbench__DOT__rstn) {
        if (vlSelfRef.Testbench__DOT__cnt_24__DOT____Vcellinp__HIGH_CNT__high_rst) {
            vlSelfRef.__Vdly__Testbench__DOT__cnt_24__DOT__low_bits = 0U;
            vlSelfRef.__Vdly__Testbench__DOT__cnt_24__DOT__high_bits = 0U;
        } else {
            if (vlSelfRef.Testbench__DOT__low_co) {
                vlSelfRef.__Vdly__Testbench__DOT__cnt_24__DOT__low_bits 
                    = ((9U == (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits))
                        ? 0U : (0xfU & ((IData)(1U) 
                                        + (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits))));
            }
            if ((9U == (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits))) {
                vlSelfRef.__Vdly__Testbench__DOT__cnt_24__DOT__high_bits 
                    = ((9U == (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__high_bits))
                        ? 0U : (0xfU & ((IData)(1U) 
                                        + (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__high_bits))));
            }
        }
    } else {
        vlSelfRef.__Vdly__Testbench__DOT__cnt_24__DOT__low_bits = 6U;
        vlSelfRef.__Vdly__Testbench__DOT__cnt_24__DOT__high_bits = 1U;
    }
}
