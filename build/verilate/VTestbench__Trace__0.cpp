...
void VTestbench___024root__trace_chg_0_sub_0(VTestbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        ...
        bufp->chgBit(oldp+7,(vlSelfRef.Testbench__DOT__cnt_24__DOT__LOW_CNT__DOT__temp_co));
        bufp->chgBit(oldp+8,(vlSelfRef.Testbench__DOT__cnt_24__DOT__HIGH_CNT__DOT__temp_co));
        bufp->chgIData(oldp+9,(vlSelfRef.Testbench__DOT__cnt_24__DOT__global_temp_co),32);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[4U]))) {
        bufp->chgCData(oldp+10,((((IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__high_bits) 
                                  << 4U) | (IData)(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits))),8);
        bufp->chgBit(oldp+11,(vlSelfRef.Testbench__DOT__error));
        bufp->chgCData(oldp+12,(vlSelfRef.Testbench__DOT__cnt_24__DOT__low_bits),4);
